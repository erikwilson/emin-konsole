...
function logArgs(name:any, result:any) {
  return (...args:any[]) => {
...
if (!globalAny.document) globalAny.document = {
  createElement: logArgs('createElement',{ getContext: logArgs('getContext',gl(200, 200, { preserveDrawingBuffer: true }))})
}
